...
tezos.setProvider({ signer: new signer_1.InMemorySigner('') });
var ApiEndpoint = "https://api.coinbase.com/v2/prices/XTZ-USD/sell";
var SmartContract = tezos.contract.at("");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                console.log(amount);
                return [4 /*yield*/, tezos.contract.at("KT1Ahbmhi9wNAetJHgKNuAeWpmFFMXeEAgQQ")];
            case 2:
                contract = _a.sent();
